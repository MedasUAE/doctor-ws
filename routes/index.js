...
module.exports = function (server) {
    ...
    server.post({ path: '/bookappointment', version: '1.0.0' }, (req, res, next) => {
        appointment.saveAppointmentDetail(req.body, (err, response) => {
            if (err) return res.send(400, { DisplayMessage: err });
            return res.send(200, { "affectedRows": response.affectedRows, "insertId": response.insertId });
        });
    })
